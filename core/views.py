...
def index(request):
    ...
    files_folder_path = 'C:\\Users\\ali_e\\Masaüstü\\Project\\File_Storage\\Files'
...
def upload(request):
    if request.method == 'POST' and request.FILES['file']:
        ...
        upload_folder = 'C:\\Users\\ali_e\\Masaüstü\\Project\\File_Storage\\Files'
...
def download(request, Filename=''):
    os.chdir('C:\\Users\\ali_e\\Masaüstü\\Project\\File_Storage\\Files')
